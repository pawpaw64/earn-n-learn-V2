...
class MaterialModel {
  ...
  static async create(materialData) {
    ...
    try {
      ...
      return { id: insertId, image_url: materialData.image_url };
    } catch (error) {
  ...
  static async update(id, materialData) {
    ...
    try {
      let query =
        "UPDATE material_marketplace SET title = ?, description = ?, `conditions` = ?, price = ?, availability = ?";
      ...
      return { success: affectedRows > 0, image_url };
    } catch (error) {
