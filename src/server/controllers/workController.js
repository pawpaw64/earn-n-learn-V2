...
export const updateWorkStatus = async (req, res) => {
    ...
    try {
        ...
        // Get work title for points description and notifications
        ...
        if (status === 'Completed') {
            ...
            await PointsController.addPointsInternal(
                ...
                100,
                'task_completed',
                `Completed work: ${workTitle}`,
                parseInt(id),
                'work_assignment'
            );

            // Award points to client for successful collaboration
            await PointsController.addPointsInternal(
                work.client_id,
                50,
                'community_participation',
                `Successful collaboration: ${workTitle}`,
                parseInt(id),
                'work_assignment'
            );
        } else {
