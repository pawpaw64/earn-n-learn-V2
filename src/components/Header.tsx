...
const Header = () => {
    ...
    return (
        <>
            ...
            <div className={`md:hidden absolute inset-0 z-40 bg-white/80 backdrop-blur-lg transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
