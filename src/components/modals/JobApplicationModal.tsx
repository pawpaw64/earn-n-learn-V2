...
const JobApplicationModal = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "Application submitted! The poster will review your application soon."
      );
      onOpenChange(false);
    } catch (error: any) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4 my-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="coverLetter"
              placeholder={`Tell ${
                job.poster || "the job poster"
              } why you're interested in this position and what makes you a great candidate.`}
              value={coverLetter}
